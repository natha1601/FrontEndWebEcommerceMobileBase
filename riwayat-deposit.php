            ...
            ?>
                ...
                <div id="ch-menu_SideNav" class="ch-ver__menu">
                    <div class="ch-aside__menu">
                        <div class="row">
                            <div class="col-sm-4">
                                <img src="assets/img/photo-profile@2x.png" width="65" alt="photo profile">
                            </div>
                            <div class="col-sm-6">
                                <p class="ch-member__name">John Doe</p>
                                <p class="ch-member__email">John@gmail.com</p>
                                <p class="ch-member__phone mb10">081289800092</p>
                ...
                <header>
                    <div class="ch-header__both clearfix">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <p class="ch-header__title">Riwayat Deposit</p>
                            </div>
                            <div class="col-sm-2 p0">
                ...
                <div class="container-fluid">
                    ...
                    <div class="ch-deposit__subheader">
                        <div class="ch-deposit__stack">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <p class="ch-nominal__deposit float-right">Rp11.898.500</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ch-history__deposit">
                        <div class="ch-history__stack">
                            <div class="ch-history__item">
                                <div class="col-sm-5 ch-order__id order-accept">
                                    Order ID 66001
                                </div>
                                <p class="ch-history__date">20/10/2017 20:00 </p>
                                <p>Transaction Debit by merchant for order : YPATRX-Batam | BTM-16400</p>
                                <div class="row mt10">
                                    <div class="col-sm-6 p0">
                                        <p class="ch-credit__text m0">Debit</p>
                                    </div>
                                    <div class="col-sm-6 p0">
                                        <p class="ch-credit__nominal nominal-accept float-right m0">Rp100.000</p>
                                    </div>
                                    <div class="col-sm-6 p0">
                                        <p class="ch-credit__text m0">Saldo</p>
                                    </div>
                                    <div class="col-sm-6 p0">
                                        <p class="ch-credit__nominal float-right m0">Rp11.998.500</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="ch-history__stack">
                            <div class="ch-history__item">
                                <div class="col-sm-5 ch-order__id order-reject">
                                    Order ID 66001
                                </div>
                                <p class="ch-history__date">20/10/2017 23:00 </p>
                                <p>Transaction Debit by merchant for order : YPATRX-Batam | BTM-16400</p>
                                <div class="row mt10">
                                    <div class="col-sm-6 p0">
                                        <p class="ch-credit__text m0">Debit</p>
                                    ...
                                    <div class="col-sm-6 p0">
                                        <p class="ch-credit__nominal nominal-reject float-right m0">-Rp100.000</p>
                                    </div>
                                    <div class="col-sm-6 p0">
                                        <p class="ch-credit__text m0">Saldo</p>
                                    </div>
                                    <div class="col-sm-6 p0">
                                        <p class="ch-credit__nominal float-right m0">Rp11.898.500</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="ch-horz__menu">
                                <a href="riwayat-deposit.php">
                                    <div class="ch-menu-middle__item">
                                        <svg class="ico--menu-footer menu-footer--active" viewBox="0 0 25.826 25.826" width="28px" height="26px">
                                        ...
                                        <span class="active">Riwayat Deposit</span>
                                    </div>
                                </a>
                            </div>
                        </div>
